        ...
        if (opcionMenu == 1) {
            ...
            if (it != usuarios.end() && it->second.contrasenia == clave) {
                ...
                do {
                    ...
                    switch (opcionCRUD) {
                        case 1: listarArticulos(articulos); break;
                        case 2: agregarArticulo(articulos); break;
                        case 3: editarArticulo(articulos); break;
                        case 4: eliminarArticulo(articulos); break;
                        case 5: comprarArticulo(articulos); break;
